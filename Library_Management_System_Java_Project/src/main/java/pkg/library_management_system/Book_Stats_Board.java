...
public class Book_Stats_Board extends javax.swing.JFrame {

    private DefaultTableModel tableModel;
    private TableRowSorter<DefaultTableModel> sorter;
    

    public Book_Stats_Board() {
        initComponents();
     ...
     private void initializeTableModel() {
        tableModel = (DefaultTableModel) Table_Stats.getModel();
        
        // Enable sorting
        sorter = new TableRowSorter<>(tableModel);
        Table_Stats.setRowSorter(sorter);
    }
      ...
      private void loadStatistics(){
        ...
        try {
            ...
            while (rs.next()) {
                ...
                row.add(rs.getString("nbr_of_borrowings"));
                row.add(rs.getString("Month"));
                row.add(rs.getString("First_Borrow_date"));
                row.add(rs.getString("Last_Borrow_date"));
    ...
    private void initComponents() {
        ...
        tf_book_stats = new javax.swing.JTextField();
        ...
        Table_Stats.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Book ISBN", "Book Title", "Category", "Nbr of Borrowings", "Month", "First Borrow Date", "Last Borrow Date"
            }
        ) {
        ...
        jScrollPane1.setViewportView(Table_Stats);
        ...
        jLabel4.setText("Search for a book by title to view the Statistics");
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(tf_book_stats, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(tf_book_stats, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel5)
    ...
    private void btn_searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_searchActionPerformed
        // TODO add your handling code here:
        String title = tf_book_stats.getText();
        ResultSet rs= Book.displayStats(title);
        //Clear the table then refill it with the resultset 
        DefaultTableModel model = (DefaultTableModel) Table_Stats.getModel();
        model.setRowCount(0); 
        try {
        ...
        while (rs != null && rs.next()) {
            Object[] row = {
                ...
                rs.getInt("nbr_of_borrowings"),
                rs.getString("Month"),
                rs.getString("First_Borrow_date"),
                rs.getString("Last_Borrow_date"),
            };
            model.addRow(row);
        }
    } catch (SQLException e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Book_Stats_Board.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField tf_book_stats;
